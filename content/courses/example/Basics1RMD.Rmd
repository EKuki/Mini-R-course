...
You can read these tutorial as it is, or you can follow along with the video in this [link](https://youtu.be/b7R8Q04jdrU). The video provides an intro to R and RStudio that is not explained in this website, so if you are really new to R/RStudio, I would recommend you to watch the video.

Similarly, I have created a [power point presentation](https://github.com/EKuki/website/blob/master/content/courses/example/1.Basics_SNA%20using%20R_18March19.pptx) that I recommend you to follow as well.
